...
export class ProjectsResolverService implements Resolve<Overview[]> {
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<Overview[]> | Observable<never> {
